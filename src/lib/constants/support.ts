...
export const SUPPORT_FAQS: SupportFaq[] = [
	...
	},
	{
		...
		answer:
			"Yes. Open any list, click the share icon, and add collaborators by email. They're added to the list immediately and can view and edit it. You can manage editors at any time from the list settings.",
	},
	{
		question: "What's the difference between list types?",
		answer:
			"Simple: checkboxes for tasks. Stepper: track quantities (e.g. ingredients). Calculator: track costs with running totals. Kanban: drag items across To Do, In Progress, and Done. Multi: mix different item types in one list.",
	},
	{
		question: "How do tags work in Tastik?",
		answer:
			"Tags help you organize and filter items within a list. They're private to that list for better privacy when sharing. Only list owners can create, edit, or delete tags, but editors can apply existing tags to items.",
	},
	{
